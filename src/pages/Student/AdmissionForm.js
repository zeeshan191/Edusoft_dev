...
function AdmissionForm() {
  ...
  const userValidation = Yup.object({
    admissionId: Yup.string().required("*This Field is Mandatory"),
              ...
              <div className="row">
                <div className="col-sm-3   form-group">
                  ...
                  <Field
                    ...
                    name="admissionId"
                  />
                  <ErrorMessage name="admissionId" component={TextError} />
                </div>
                <div className="col-sm-3 form-group">
                ...
                <div className="col-sm-3 form-group">
                  ...
                  <Field
                    ...
                    id="fatherOccupation"
                  />
                  <ErrorMessage name="fatherOccupation" component={TextError} />
                </div>
